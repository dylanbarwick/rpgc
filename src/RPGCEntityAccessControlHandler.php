...
/**
 * Access controller for the RPGC Entity entity.
 *
 * @see \Drupal\rpgc\Entity\RPGCEntity.
 */
class RPGCEntityAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\rpgc\Entity\RPGCEntityInterface $entity */
    ...
    switch ($operation) {
      ...
      case 'view':
        ...
        if (!$entity->isPublished()) {
          ...
          return AccessResult::allowedIfHasPermission($account, 'view unpublished rpgc entity entities');
        }
        ...
        return AccessResult::allowedIfHasPermission($account, 'view published rpgc entity entities');
      ...
      case 'update':
        ...
        return AccessResult::allowedIfHasPermission($account, 'edit rpgc entity entities');
      ...
      case 'delete':
        ...
        return AccessResult::allowedIfHasPermission($account, 'delete rpgc entity entities');
    }
